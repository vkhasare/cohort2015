...
typedef struct RBT_tree {
  ...
  void (*DestroyInfo)(unsigned int a);
  void (*PrintKey)(unsigned int a);
  void (*PrintInfo)(unsigned int a);
...
RBT_tree* RBTreeCreate(int  (*CompFunc)(const void*, const void*),
           ...
           void (*PrintInfo)(void*));
RBT_node * RBTreeInsert(RBT_tree*, unsigned int , struct sockaddr *, unsigned int, avail_state);
